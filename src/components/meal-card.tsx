...
export function MealCard({
  ...
  return (
    <div className="flex gap-3 rounded-2xl border border-border bg-muted/40 p-3 transition-colors hover:bg-muted/70">
      <button
        type="button"
        className="flex min-w-0 flex-1 gap-3 rounded-xl bg-transparent p-0 text-left outline-none focus-visible:ring-2 focus-visible:ring-ring/50"
